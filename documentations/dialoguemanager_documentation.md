...
This document serves as a technical reference for the `DialogueManager` module. It provides context on the design patterns, responsibilities, and specific implementations of this system in the Companix Godot project.
